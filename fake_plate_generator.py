...
class FakePlateGenerator(): 
    def __init__(self, fake_resource_dir, plate_size):
        ...
        #position for "苏A"
        self.character_position_x_list_part_1 = [43+20, 111+20]  
        #position for "xxxxx"              
        self.character_position_x_list_part_2 = [205+20, 269+20, 330+20, 395+20, 464+20]
    ...
    def generate_one_plate(self):
        ...
        start_xy.append(self.add_character_to_plate(img1, plate_img, self.character_position_x_list_part_1[0]))
        plate_name += "%s"%(character,)
        plate_chars += character

        character, img = self.get_radom_sample(self.letters)
        start_xy.append(self.add_character_to_plate(img, plate_img, self.character_position_x_list_part_1[1]))
        plate_name += "%s"%(character,)
        plate_chars += character
